...
def get_embedder(multires, i=0):#编码部分 the encoding part in this project
    if i == -1:
    ...
    }#位置编码参数，这里我们改成哈希编码 -->position_encoding to hash_encoding
    ...
    embed = lambda x, encoding_func=encoding: encoding_func(x)
    return embed, encoding.n_output_dims
